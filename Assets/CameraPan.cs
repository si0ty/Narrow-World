   ...
   public bool horizontal;
    ...
    void Start()
    {
        ...
        GetComponent<Button>().onClick.AddListener(() => {
            ...
            if (horizontal) {
                if (!secondRoom) {
                    camera.transform.DOMoveX(panRange, 1.8f).SetEase(Ease.InOutSine);
                    ...
                    camera.transform.DOMoveX(0, 2.2f).SetEase(Ease.InOutSine);
                    demonImage.DOFade(0, 1f).SetEase(Ease.InOutSine);
                ...
                if (!secondRoom) {
                    camera.transform.DOMoveY(panRange, 1.8f).SetEase(Ease.InOutSine);
                    demonImage.DOFade(0, 1f).SetEase(Ease.InOutSine);
                    demonImage.sprite = knightImage;
                    demonImage.DOFade(0, 0);
                    demonImage.DOFade(1, 1.8f).SetEase(Ease.InOutSine);
                    ...
                    camera.transform.DOMoveY(0, 2.2f).SetEase(Ease.InOutSine);
                    demonImage.DOFade(0, 1f).SetEase(Ease.InOutSine);
                    demonImage.sprite = demonSprite;
                    demonImage.DOFade(0, 0);
                    demonImage.DOFade(1, 1.8f).SetEase(Ease.InOutSine);
